...
from utils.models.convLSTM import convLSTM4_5 as Model
...
parameters = {}
parameters['lr'] = 3e-6
parameters['descrption'] = 'Single Cell in LSTM, all gradients detached - no tanh -  no sigmoid - no prev input'
