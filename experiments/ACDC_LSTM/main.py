...
from utils.DDP_paradigms_LSTM import train_paradigm, test_paradigm
...
sys.path.append('/root/Cardiac-MRI-Reconstrucion/experiments/ACDC_LSTM/{}/'.format(args.run_id))
