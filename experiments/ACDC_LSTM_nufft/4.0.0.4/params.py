...
parameters['num_epochs_ispace'] = 100
parameters['num_epochs_kspace'] = 100
parameters['kspace_architecture'] = 'KLSTM2'
parameters['ispace_architecture'] = 'ILSTM2'
