...
class ACDC(Dataset):
    ...
    def __init__(self, path, train = True, blank = False, window_mode = False):
        ...
        self.num_coils = 1
        self.window_size = 7
        self.ft_num_radial_views = 14
        self.norm = False
        self.memoise_disable = False
        self.window_mode = window_mode
        assert(self.window_size % 2 != 0)
        self.predict_mode = 'last'
    ...
    def __getitem__(self, i):
        ...
        current_window_mask += 1
        return torch.tensor([p_num, v_num, f_num]), r_ft_data, current_window_mask.unsqueeze(1), target.float().cpu().unsqueeze(1), target_ft, period.cpu()
