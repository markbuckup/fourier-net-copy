...
otfile.write('Run ID, Batch Size, Recon Loss, Recon-FT Loss, FT Loss, Train SSIM, Test SSIM, Train L1, Test L1, Train RMSE, Test RMSE\n')
...
for run_ids in sorted(os.listdir('.')):
	...
	with open(os.path.join(run_ids, 'test.log'), 'r') as f:
		...
		otfile.write(',')
		otfile.write(mydic['train_batch_size'])
		otfile.write(',')
